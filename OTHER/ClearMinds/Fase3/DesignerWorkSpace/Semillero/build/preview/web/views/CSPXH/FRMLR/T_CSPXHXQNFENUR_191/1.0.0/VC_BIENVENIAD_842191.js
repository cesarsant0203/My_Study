...
cobisMainModule.controllerProvider.register("VC_BIENVENIAD_842191_CTRL", ["cobisMessage", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout", "$translate",
...
serverEvents: false},
"/CTSProxy/services/resources/CSPXH/FRMLR/T_CSPXHXQNFENUR_191",
...
var cobisMainModule = cobis.createModule("VC_BIENVENIAD_842191", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", "designerModule"],[]);
