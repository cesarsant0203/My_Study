...
<!!!REPLACEME with code to ask user for the Webex Temas Access Token or use a hard-coded one!!!>
...
resp = requests.get(   "<!!!REPLACEME with URL for Webex Teams Rooms API!!!>",
