          ...
          if ((movimiento == 25) && (arrTwoTwo == 0) ){
            ...
            if ((movimiento == 32) && (arrOneTwo == 0) ){
              ...
              if ((movimiento == 36) && (arrTwoThree == 0) ){
                arrTwoThree = await arrTwoThree + arrOneThree;
                arrOneThree = await arrOneThree - arrOneThree;
                console.log(arrOneOne, arrOneTwo, arrOneThree);
                console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                ...
                if ((movimiento == 41) && (arrOneOne == 0) ){
                  arrOneOne = await arrOneOne + arrTwoOne;
                  arrTwoOne = await arrTwoOne - arrTwoOne;
                  console.log(arrOneOne, arrOneTwo, arrOneThree);
                  console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                  console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                }else{
                  if ((movimiento == 45) && (arrTwoTwo == 0) ){
                    arrTwoTwo = await arrTwoTwo + arrTwoOne;
                    arrTwoOne = await arrTwoOne - arrTwoOne;
                    console.log(arrOneOne, arrOneTwo, arrOneThree);
                    console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                    console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                    ...
                    if ((movimiento == 47) && (arrThreeOne == 0) ){
                      arrThreeOne = await arrThreeOne + arrTwoOne;
                      arrTwoOne = await arrTwoOne - arrTwoOne;
                      console.log(arrOneOne, arrOneTwo, arrOneThree);
                      console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                      console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                      ...
                      if ((movimiento == 52) && (arrOneTwo == 0) ){
                        arrThreeOne = await arrOneTwo + arrTwoTwo;
                        arrTwoTwo = await arrTwoTwo - arrTwoTwo;
                        console.log(arrOneOne, arrOneTwo, arrOneThree);
                        console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                        console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                      }else{
                        if ((movimiento == 54) && (arrTwoOne == 0) ){
                          arrThreeOne = await arrTwoOne + arrTwoTwo;
                          arrTwoTwo = await arrTwoTwo - arrTwoTwo;
                          console.log(arrOneOne, arrOneTwo, arrOneThree);
                          console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                          console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                          ...
                          if ((movimiento == 56) && (arrTwoThree == 0) ){
                            arrTwoThree = await arrTwoThree + arrTwoTwo;
                            arrTwoTwo = await arrTwoTwo - arrTwoTwo;
                            console.log(arrOneOne, arrOneTwo, arrOneThree);
                            console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                            console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                            ...
                            if ((movimiento == 58) && (arrThreeTwo == 0) ){
                              arrThreeTwo = await arrThreeTwo + arrTwoTwo;
                              arrTwoTwo = await arrTwoTwo - arrTwoTwo;
                              console.log(arrOneOne, arrOneTwo, arrOneThree);
                              console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                              console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                              ...
                              if ((movimiento == 63) && (arrOneThree == 0) ){
                                arrOneThree = await arrOneThree + arrTwoThree;
                                arrTwoThree = await arrTwoThree - arrTwoThree;
                                console.log(arrOneOne, arrOneTwo, arrOneThree);
                                console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                              }else{
                                if ((movimiento == 65) && (arrTwoTwo == 0) ){
                                  arrTwoTwo = await arrTwoTwo + arrTwoThree;
                                  arrTwoThree = await arrTwoThree - arrTwoThree;
                                  console.log(arrOneOne, arrOneTwo, arrOneThree);
                                  console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                  console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                  ...
                                  if ((movimiento == 69) && (arrThreeT == 0) ){
                                    arrThreeT = await arrThreeT + arrTwoThree;
                                    arrTwoThree = await arrTwoThree - arrTwoThree;
                                    console.log(arrOneOne, arrOneTwo, arrOneThree);
                                    console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                    console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                    ...
                                    if ((movimiento == 74) && (arrTwoOne == 0) ){
                                      arrTwoOne = await arrTwoOne + arrThreeOne;
                                      arrThreeOne = await arrThreeOne - arrThreeOne;
                                      console.log(arrOneOne, arrOneTwo, arrOneThree);
                                      console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                      console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                    }else{
                                      if ((movimiento == 78) && (arrThreeTwo == 0) ){
                                        arrThreeTwo = await arrThreeTwo + arrThreeOne;
                                        arrThreeOne = await arrThreeOne - arrThreeOne;
                                        console.log(arrOneOne, arrOneTwo, arrOneThree);
                                        console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                        console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                        ...
                                        if ((movimiento == 87) && (arrThreeOne == 0) ){
                                          arrThreeOne = await arrThreeOne + arrThreeTwo;
                                          arrThreeTwo = await arrThreeTwo - arrThreeTwo;
                                          console.log(arrOneOne, arrOneTwo, arrOneThree);
                                          console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                          console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                        }else{
                                          if ((movimiento == 85) && (arrTwoTwo == 0) ){
                                            arrTwoTwo = await arrTwoTwo + arrThreeTwo;
                                            arrThreeTwo = await arrThreeTwo - arrThreeTwo;
                                            console.log(arrOneOne, arrOneTwo, arrOneThree);
                                            console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                            console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                            ...
                                            if ((movimiento == 89) && (arrThreeT == 0) ){
                                              arrThreeT = await arrThreeT + arrThreeTwo;
                                              arrThreeTwo = await arrThreeTwo - arrThreeTwo;
                                              console.log(arrOneOne, arrOneTwo, arrOneThree);
                                              console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                              console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                              ...
                                              if ((movimiento == 98) && (arrThreeTwo == 0) ){
                                                arrThreeTwo = await arrThreeTwo + arrThreeT;
                                                arrThreeT = await arrThreeT - arrThreeT;
                                                console.log(arrOneOne, arrOneTwo, arrOneThree);
                                                console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                                console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                              }else{
                                                if ((movimiento == 96) && (arrTwoThree == 0) ){
                                                  arrTwoThree = await arrTwoThree + arrThreeT;
                                                  arrThreeT = await arrThreeT - arrThreeT;
                                                  console.log(arrOneOne, arrOneTwo, arrOneThree);
                                                  console.log(arrTwoOne,arrTwoTwo, arrTwoThree);
                                                  console.log(arrThreeOne, arrThreeTwo, arrThreeT);
                                                }else{
                                                  console.log('Haces huevadas')
                                                }
                                              }
                                            }
                                          }
