...
async function all(){
if (
  (arrOneOne == arrOOneOne) && (arrOneTwo == arrOOneTwo) && (arrOneThree == arrOOneThree) && (arrTwoOne == arrOTwoOne) && (arrTwoTwo == arrOTwoTwo) && (arrTwoThree == arrTwoThree) && (arrThreeOne == arrThreeOne ) && (arrThreeTwo == arrThreeTwo) &&
  (arrThreeT == arrThreeT)){
  console.log('GANASTE');
}else{
