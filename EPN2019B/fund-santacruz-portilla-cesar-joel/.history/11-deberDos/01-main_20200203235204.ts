...
if (
  (arrOneOne == arrOOneOne) && (arrOneTwo == arrOOneTwo) && (arrOneThree == arrOOneThree) && (arrTwoOne == arrTwoOne) && (arrTwoTwo == arrTwoTwo) && (arrTwoThree == arrTwoThree) && (arrThreeOne == arrThreeOne ) &&
  =\(arrThreeTwo == arrThreeTwo) &&
  (arrThreeT == arrThreeT) &&){
  console.log('GANASTE');
}else{
