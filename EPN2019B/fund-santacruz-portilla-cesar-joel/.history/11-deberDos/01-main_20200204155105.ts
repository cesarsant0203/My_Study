...
async function all(){
if (
  (arrOneOne == arrOOneOne) && (arrOneTwo == arrOOneTwo) && (arrOneThree == arrOOneThree) && (arrTwoOne == arrOTwoOne) && (arrTwoTwo == arrOTwoTwo) && (arrTwoThree == arrOTwoThree) && (arrThreeOne == arrOThreeOne ) && (arrThreeTwo == arrOThreeTwo) &&(arrThreeT == arrOThreeT)){
  console.log('GANASTE');
}else{
