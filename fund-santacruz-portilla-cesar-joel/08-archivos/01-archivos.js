...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var contador, contenidoArchivo, arregloCargadoDelArchivo, arregloEstudiantes, arregloPreguntas, respuestaEstudianteUno, nuevoRegistroUno, respuestaEstudianteDos, nuevoRegistroDos, idABuscar, indiceEncontrado, nombreAEditar, buscar, estudianteEncontrado;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    contador = 1;
                    contenidoArchivo = _02_leer_archivo_1.leerArchivo('./ejemplo.txt');
                    arregloCargadoDelArchivo = JSON.parse(contenidoArchivo);
                    arregloEstudiantes = arregloCargadoDelArchivo;
                    arregloPreguntas = [
                        {
                            type: 'text',
                            name: 'nombre',
