...
//arr = shuffle(arr);
let arrOneOne = (arr[0], arr[1] , arr[2]);
let arrOneTwo = (arr[0], arr[1] , arr[2]);
let arrOneThree = (arr[0], arr[1] , arr[2]);
let arrTwoOne = [arr[3],arr[4],arr[5]];
let arrTwoTwo = [arr[3],arr[4],arr[5]];
let arrTwoThree = [arr[3],arr[4],arr[5]];
let arrThreeOne = [arr[6],arr[7],arr[8]];
let arrThreeTwo = [arr[6],arr[7],arr[8]];
let arrThreeThree = [arr[6],arr[7],arr[8]];
