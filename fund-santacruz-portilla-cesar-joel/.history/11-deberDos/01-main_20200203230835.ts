...
let arrOrdenado = [1, 2, 3, 4, 5, 6, 7, 8, 0];
//arr = shuffle(arr);
let arrOne = [arr[0],arr[1],arr[2]];
let arrTwo = [arr[3],arr[4],arr[5]];
let arrThree = [arr[6],arr[7],arr[8]];
let arrOOne = [arr[0],arr[1],arr[2]];
let arrOTwo = [arr[3],arr[4],arr[5]];
let arrOThree = [arr[6],arr[7],arr[8]];
//////////////////////////////////////////////
...
if (arrOne == arrOOne && arrTwo == arrOTwo && arrThree == [ 7, 8, 0 ] ){
  console.log('GANASTE');
}else{
