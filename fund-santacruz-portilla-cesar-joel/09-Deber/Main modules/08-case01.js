...
function caseOne() {
    return __awaiter(this, void 0, void 0, function () {
        var arregloPreguntas, contador, arregloCarros, respuestaCarroUno, nuevoRegistroUno, arregloTexto;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _05_Iniciar_archivos_1.iniciar()];
                case 1:
                    arregloPreguntas = _a.sent();
                    return [4 /*yield*/, _07_id_archivos_1.idArchivo()];
                case 2:
                    contador = _a.sent();
