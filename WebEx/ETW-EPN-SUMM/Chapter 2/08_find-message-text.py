...
for message in messages:
    if message["text"].find(messageText) != -1:
        ...
        # recordar que lo que se encuentra dentro de message[] es un value key
        print("From: " + message["personEmail"])  
        print("Email created on: " + message["created"])
...
if messageCounter == 0:
            ...
            print( str(messageCounter) + " messages found")
