...
<!!!REPLACEME with code to ask user for the Webex Teams Access Token or use a hard-coded one!!!>
...
while True:
    ...
    if message.find("/") == 0:
        ...
        locationLng = json_data["results"][0]["locations"][0]["latLng"]["<!!!REPLACEME with the longtitude key!!!>"]
        # print the location address
        ...
        r = requests.post( "<!!!REPLACEME with URL for Webex Teams messages API!!!>", 
